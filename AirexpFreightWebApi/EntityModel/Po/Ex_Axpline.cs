...
namespace EntityModel.Po
{
    ...
    public class Ex_Axpline
    {
        ...
        public string bzlxpiece { get; set; }
        ...
        public string code_fhr_hawb { get; set; }
        public string companytitle_fhr_hawb { get; set; }
        public string address_fhr_hawb { get; set; }
        public string city_fhr_hawb { get; set; }
        public string postcode_fhr_hawb { get; set; }
        public string companycode_fhr_hawb { get; set; }
        public string state_fhr_hawb { get; set; }
        public string lxr_fhr_hawb { get; set; }
        public string phone_fhr_hawb { get; set; }
        public string email_fhr_hawb { get; set; }
        public string fax_fhr_hawb { get; set; }
        public string code_shr_hawb { get; set; }
        public string companytitle_shr_hawb { get; set; }
        public string address_shr_hawb { get; set; }
        public string city_shr_hawb { get; set; }
        public string postcode_shr_hawb { get; set; }
        public string companycode_shr_hawb { get; set; }
        public string state_shr_hawb { get; set; }
        public string lxr_shr_hawb { get; set; }
        public string phone_shr_hawb { get; set; }
        public string email_shr_hawb { get; set; }
        public string fax_shr_hawb { get; set; }
        ...
        private int _timestamp { get; set; }
